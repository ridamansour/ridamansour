...
* 🎙️ **Conversational Agents & Perception Ensembles:** Built a real-time conversational interview agent using a decoupled Interviewer/Evaluator architecture, feeding into a post-session perception scoring ensemble (facial expression and emotion classification, gaze tracking, prosodic audio analysis, and synthetic text/speech detection).
